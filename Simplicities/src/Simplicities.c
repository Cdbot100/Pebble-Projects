//this code is a modified version of "simplicity" && "Weather.js" from  SDK\Examples
...
static void init(void) {
    ...
    window_set_background_color(window, GColorBlack);   //set background, load window
    ...
    Tuplet initial_values[] = {                         //init to blank
        TupletCString(WEATHER_TEMPERATURE_KEY, ""),     //temp
